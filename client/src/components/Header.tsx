  ...
  return (
    <div className="flex items-center justify-between px-8 py-4 border-b border-white/5 flex-shrink-0">
      ...
      <div className="flex items-center gap-4">
        <span className="font-mono text-sm font-bold tracking-[0.2em] text-[#00FFFF]">
          COMMAND CENTER
        </span>
        <div className="w-px h-5 bg-white/10" />
        <div className="flex items-center gap-2">
          <div
            className={`w-2 h-2 rounded-full ${currentScene.category === 'brand' ? 'bg-[#39FF14]' : 'bg-[#00FFFF]'}`}
          />
      ...
      <div className="flex items-center gap-6">
        ...
        <button
          ...
          className="font-mono text-xs text-white/30 hover:text-white/60 transition-colors bg-white/5 border border-white/10 rounded-lg px-3 py-1.5"
        >
